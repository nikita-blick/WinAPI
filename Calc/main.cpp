...
LRESULT CALLBACK WndProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	{
		HDC hdc = (HDC)wParam;     // C сообщение WM_CTLCOLOREDIT in 'wParam' принимается HDC элемента EditControl
	...
	case WM_CONTEXTMENU:
	{
		...
		AppendMenu(cmMain, MF_STRING, IDM_METAL_MIXTRAL, "Metal mixtral");
		...
		case IDM_METAL_MIXTRAL:	skinID = 1;	break;
